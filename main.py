...
def get_notes(uploaded_file):
    """ Get all the notes and chords from the midi file """
    notes = []

    midi = converter.parse(uploaded_file)

    print("Parsing %s" % uploaded_file)
...
generate()
st.spinner(text="In progress...generating music")
st.download_button(
    label="Download your midi file",
    data='lofi_output4.mid',
